...
function HomeAppliances() {
  ...
  function prevImage(){
    let box=document.querySelector('.card-image-home')
...
function Allitems(category){
  ...
  const home = data.filter(ele => ele.category && ele.category.includes('Home&Kitchen|Heating,Cooling&AirQuality'))
