...
function Kitchen() {
  ...
  function prevImage(){
    let box=document.querySelector('.card-image-kitchen')
...
function Allitems(category){
  ...
  const kitchen = data.filter(ele => ele.category && ele.category.includes('Kitchen&HomeAppliances'))
  ...
  return (
    ...
    <div className='card-image-kitchen'>
      {
